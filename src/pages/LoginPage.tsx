  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        setError(err.message); // Now using the specific error message from AuthContext
      } else {
    ...
    <div className="min-h-screen pt-28 pb-20 bg-gray-50 flex items-center">
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden">
          <div className="p-8">
            <h1 className="text-2xl font-bold text-gray-800 mb-6 text-center">Log In to Education Centre</h1>
